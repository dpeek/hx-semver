...
class ExecMtaskCommand(sublime_plugin.WindowCommand, ProcessListener):
    def run(self, cmd = [], file_regex = "", line_regex = "", working_dir = "",
        ...
        working_dir = msublime.working_dir()
    ...
    def append_data(self, proc, data):
        ...
        try:
            output = data.decode(self.encoding)
        except:
            output = "[Decode error - output not " + self.encoding + "]\n"
            proc = None
